...
Sistema de planejamento de cardápio mensal com repertório de pratos e atribuição de cozinheiro.
...
### US-04: Atribuir cozinheiro
**Como** usuário
**Quero** definir quem vai preparar cada refeição
**Para** organizar a cozinha

### US-05: Ver cardápio da semana
**Como** usuário
...
│  Observações                           │
│  ┌──────────────────────────────────┐ │
│  │ Fazer porção extra para visita    │ │
│  └──────────────────────────────────┘ │
│                                        │
│              [Cancelar]  [Salvar]      │
│                                        │
...
│  ┌──────────────────────────────────────────────────┐ │
│  │ Preparar o arroz e o feijão separadamente...      │ │
│  └──────────────────────────────────────────────────┘ │
│                                                        │
│                        [Cancelar]  [Salvar]            │
│                                                        │
...
| category | Obrigatório, enum válido |
| prepTime | Opcional, número positivo |
| servings | Opcional, número positivo |
| ingredients | Opcional, array de strings |
...
| mealType | Obrigatório, enum válido |
...
└─────────────┘     └─────────────┘     └─────────────┘
                          ...
                          ▼
┌─────────────┐     ┌─────────────┐     ┌─────────────┐
│   Fechar    │◀────│   Salvar    │◀────│  Atribuir   │
│   Modal     │     │   no DB     │     │  Cozinheiro │
└─────────────┘     └─────────────┘     └─────────────┘
```
